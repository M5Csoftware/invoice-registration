      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-slate-300 rounded px-3 py-2 text-xs sm:text-sm focus:outline-none focus:ring-1 focus:ring-brass focus:border-brass text-ink-dark shadow-md"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded px-3 py-2 text-xs sm:text-sm font-mono focus:outline-none focus:ring-1 focus:ring-brass focus:border-brass text-ink-dark shadow-md"
              />
            </div>
            <div>
              <label className="text-xs font-bold uppercase tracking-wider text-slate-700 mb-1 flex items-center gap-1">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded px-3 py-2 text-xs sm:text-sm font-mono uppercase focus:outline-none focus:ring-1 focus:ring-brass focus:border-brass text-ink-dark shadow-md"
              />
            </div>
          </div>
        </div>
        ...
        <div className="pt-2 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="border border-slate-300 text-slate-700 hover:bg-slate-50 text-xs font-semibold px-4 py-2 rounded transition-colors cursor-pointer"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="bg-brass hover:bg-brass-light text-white text-xs font-semibold px-4 py-2 rounded shadow-md transition-colors cursor-pointer flex items-center gap-1.5"
          >
